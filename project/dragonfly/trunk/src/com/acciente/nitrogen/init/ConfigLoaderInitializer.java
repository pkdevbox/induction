 ...
 * file named using the convention [servlet-name]-nitrogen.xml residing in the
 ...
 * in which case no [servlet-name]-nitrogen.xml is expected. In fact the
 * [servlet-name]-nitrogen.xml is what is loaded by the default configuration
