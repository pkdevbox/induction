...
public class ViewParameterProviderFactory
{
   ...
   public ParameterProvider getParameterProvider( HttpServletRequest       oRequest,
                                                  HttpServletResponse      oResponse,
                                                  ViewResolver.Resolution  oResolution )
   {
      return new ParameterProvider( oRequest, oResponse, oResolution );
   }

   private class ParameterProvider implements com.acciente.commons.reflect.ParameterProvider
   {
      private  HttpServletRequest            _oRequest;
      private  HttpServletResponse           _oResponse;
      private  ViewResolver.Resolution       _oResolution;

      private ParameterProvider( HttpServletRequest         oRequest,
                                 HttpServletResponse        oResponse,
                                 ViewResolver.Resolution    oResolution )
      {
         _oRequest         = oRequest;
